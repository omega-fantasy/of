...
\ofspell{Protect}{6}{1}{Ranged}{HP+8, MP+12, DEF+1, RES+1}{One target gains EnDEF \& EnRES for 2r.}\vfill
\ofspell{Imperil}{6}{1}{Ranged}{HP+8, MP+12, MAG+1, RES+1}{One target suffers DeDEF \& DeRES for 2r.}\vfill
...
\ofspell{Bio}{8}{4}{Ranged}{HP+7, MP+18, MAG+1\hfill Requires: Poison}{One target makes a DC8 check and suffers 2d damage and Poison for 3r upon failure.}\vfill
...
\ofspell{NulElement}{16}{6}{Ranged}{HP+8, MP+12, RES+2\hfill Requires: Protect}{Choose an element (e.g. fire). One target does not suffer any damage of the chosen element for 3r.}\vfill
...
\ofspell{Float}{10}{6}{Ranged}{HP+10, MP+10, DEF+1, RES+1\hfill Requires Gravity}{For 3r, one target gains Resistance against all damage from effects that target their entire row.}\vfill
\ofspell{Veil}{12}{6}{Ranged}{HP+10, MP+10, DEF+1, RES+1\hfill Requires: Imperil}{One target gains Immunity against all negative Status Effects for 3r.}\vfill
%Comet
%
...
\ofspell{Aeroga}{20}{8}{Ranged}{HP+9, MP+11, MAG+2\hfill Requires: Aero}{All targets in a row suffer 3d wind damage and make a DC6 check and switch row upon failure.}\vfill
...
\ofspell{Reflect}{16}{8}{Melee}{HP+9, MP+16, RES+1\hfill Requies: Veil}{One target gains a shield that reflects the next spell that targets them back to its caster. This effect does not stack.}\vfill
...
\ofspell{Swap}{12}{8}{Melee}{HP+12, MP+13, DEF+1\hfill Requires: Warp}{Switch your position with an ally in the other row. Both of you gain EnSTR \& EnMAG for 1r.}\vfill
%
...
\ofspell{Dualcast}{0}{10}{Self}{HP+5, MP+20, MAG+1\hfill Requires: any 4 LV1 spells}{Cast two spells that are LV4 or lower simultaneously, but need to spend the necessary MP for both.}\vfill
...
%
% vox/astra: target gains status effect immunity for x rounds
% float//exchange
\clearpage
%
