...
\ofjob{Bardo}
{
	...
	Entretanto, Bardos não são os duelistas mais poderosos, em geral eles viram a maré da batalha de maneias inesperadas.
}
{Adaga}{Armadura Leve ou Robe}{
	...
	{\ofspecial{Vestido(a) para arrasar}{Equipe um acessório extra. Além disso, para cada acessório equipado, você pode escolher um benefício extra entre: DEF+1 ou RES+1.}{5}{\oficonpassive}}	
	...
	{\ofarchetypetechb{Dança Lenta}{12}{0r}{2u}{Você}{Crie um campo especial ao seu redor que dure por 3 rodadas, agindo tanto como um campo Ardente e Vagaroso. O campo se move com você e afeta somente inimigos.}{}}
}{
...
\ofjob{Mago Negro}
{
	...
	Garantindo grande controle sobre o campo de batalha e são difíceis de serem ignorados pelos inimigos.
}
{Cajado}{Robe}{
	...
	{\ofarchetypepassive{Campo elemental}{Ao conjurar uma magia que cause dano de Fogo, Gelo ou Raio, também crie um campo ao redor do alvo de área até 2u, que dure por 1 rodada. O efeito do campo depende do elemento da magia: Fogo - Campo Ardente, Gelo - Campo Derrapante ou Raio - Campo Vagaroso.}}
...
{Lança}{Armadura Pesada}{
	...
	\ofjobtech{Salto duplo}{8}{1r}{Único}{3u}{Ao começar a usar essa técnica, salte até 3u no ar. Após a conjuração, salte sobre o alvo e o ataque. É possível saltar a outro local dentro de 3u. Se aterrizar em outro inimigo, ataque-o também.}{}{6}\ofabilitygap
	...
	\ofjobtech{Ventania}{24}{1r}{Único}{Você}{Por 3 rodadas, você permanece até 3u no ar, de onde você pode ser mover normalmente e realiza uma das seguintes ações, sem custo de PM adicional:\\ 
		...
		\acc{Explosão de Fogo:} escolha um alvo dentro de 10u. Ele e inimigos dentro de 2u sofrem 4d de dano de Fogo.}{\fire}{10}
}{
...
\ofjob{Monge}
{
	...
	\accf{Monges} São lutadores adepto ao combate físico que possuem uma combinação mortal de força e técnica.
...
{Nenhuma}{Armadura Leve}{
	...
	{\ofarchetypereaction{Retribuição}{Ao se evadir com sucesso do ataque inimigo, você pode atacá-lo de imediato, se ele estiver ao seu alcance.}}
...
{Cajado ou Espada}{Armadura Leve ou Robe}{
	...
	\ofjobspell{Desproteger}{8}{0r}{Único}{5u}{O alvo sofre ReDEF e ReRES por 3 rodadas.}{}{8}\ofabilitygap
	...
	{\ofarchetypepassive{Sobrepujar}{Ao causar dano elemental, o alvo recebe fraqueza contra o mesmo tipo até o fim de próximo turno dele. Ignore a Resistência ao elemento, caso ele tenha.}}
	...
	{\ofarchetypereaction{Escudo de Mana}{Ao ter seu PV é reduzido, você pode escolher reduzir seu PM ao invés.}}
...
\ofjob{Invocador}
{
	...
	Muitos heorois poderosos são capazes de invocar criaturas, mas o vínculo criado pelos \accf{Invocadores} são muito mais fortes, permitindo-os manifestar invocações por um longo período de tempo para lutar ao seu lato no campo de batalha. 
}
{Cajado or Bastão}{Robe}{
	...
	\ofjobspell{Invocar}{8}{1r}{1u}{1u}{
		...
		Eles são dispensados quando sofrerem KO, se você invocar novamente ou ao final da batalha.
...
{\accf{Mordida}: 1d de dano(aumenta para 2d no Nível 5)}
{
	...
	\mspell{Luz Rubi \hfill \accf{Nível 10}}{24}{1r}{2u}{8u}{Aliados na área de efeito ganham Regenerando por 3 rodadas e um escudo que reflete a próxima magia que os atingir de volta para o conjurador.}{}
}
%
\vspace*{1.8cm}\\
%
...
\ofjob{Ladrão}
{
	...
	\accf{Ladrões} são lutadores ágeis, incomparáveis em "pegar emprestado"  itens de inimigos e tem um senso apurado para negócios que valem a pena.
}
{Adaga}{Armadura Leve}{
...
{Arcos ou Arma ou Lança}{Robe}{
	...
	{\ofarchetypepassive{Síntese}{Ganhe FOR+1, DEF+1 ou RES+1 adicional por cada Matéria que tenha equipado.}}
...
{Cajado}{Robe}{
	...
	\ofjobspell{Devagar}{8}{0r}{Único}{5u}{O alvo fica Lento por 3 rodadas.}{\slow}{2}\ofabilitygap
	...
	{\ofarchetypespellb{Apressar}{12}{0r}{Único}{5u}{O alvo tem um turno extra antes de terminar o seu próprio, mas só uma vez por rodada. Após isso, você ainda pode escolher o próximo a agir do lado do seu grupo normalmente. }{}}
}
%
%
%
...
{Espada}{Armadura Leve e Pesada}{
	...
	\ofjobtech{Exército de um Só}{10}{0r}{3u}{Você}{Ataque cada inimigo na área rolando um dano que se aplica a todos que falharem em se evadir. Após isso, você pode se mover para próximo de qualquer um dos alvos afetados.}{}{6}\ofabilitygap
	\ofjobtech{Bravura}{10}{0r}{2u}{Você}{Você e seus aliados dentro da área de efeito ganham AuFOR e AuMAG por 2 rodadas.}{\enstr \enmag}{8}\ofabilitygap
	...
	{\ofarchetypepassive{Mutilar}{Sempre que o alvo de seus ataques rolar 5 ou menos no teste de evasão, ele recebe um dos seguintes Efeito de Estado: Imóvel, Cego ou ReFOR.}}
...
\ofjob{Mago Branco}
{
	...
	São medíocre em combate físico, mas possuem alta resistência contra magias.
}
{Cajado}{Robe}{
	...
	\ofjobspell{Limpar}{6}{0r}{5u}{50u}{Remova um Campo de Efeito dentro da área.}{}{6}\ofabilitygap
	\ofjobspell{Sagrado}{21}{2r}{Único}{12u}{Cause 6d+45 de dano Sagrado ao alvo.}{\holy}{8}\ofabilitygap
	\ofjobspell{Auto-Vida}{28}{2r}{Único}{3u}{Invoque um anjo guardião que  zela por você. Na próxima vez que você ficar KO, seja revivido com 1 PV. Esse efeito não acumula e se não ativado, expira se o alvo dormir. }{\ko}{10}
}{
	\ofarchetypet{Sábio}
