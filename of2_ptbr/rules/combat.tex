...
\vfill
%
\ofboxwithtitle{Exemplo: Combate}
{
...
\vfill
%
\accf{Unidades} (\accf{u}) são a base para se medir distâncias, em que 1u é aproximadamente 1m ou 3 pés. 
...
\vfill
%
\accf{Campos} são efeitos que ocupam uma área no campo de batalha e afetam a todos dentro dele. 
