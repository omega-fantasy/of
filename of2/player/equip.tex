...
{\oficonweapon\accf{Staff} & \accf{Unique Effect}}
{
	...
	\ofequipnote{Staves increase the wielder's maximum MP by 5 per increase in equipment rank (for example a Beginner staff grants maximum MP~+5). In exchange, staves cannot have more than 1d DMG.}
}
%
\vfill
%
...
{\oficonweapon\accf{Rod} & \accf{Unique Effect}}
{
	...
	\ofequipnote{Rods increase the wielder's MAG by one per increase in equipment rank (for example a Beginner rod grants MAG~+1). In exchange, rods cannot have more than 1d DMG.}
}
%
%
\newpage
