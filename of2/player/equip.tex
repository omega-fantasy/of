...
{\oficonweapon\accf{Bow} & \accf{Unique Effect}}
{
	...
	Elfin Bow & Add 3 to the damage when you Attack a target that suffering a Status Effect\ofrow
...
{\oficonweapon\accf{Staff} & \accf{Unique Effect}}
{
	...
	\ofequipnote{Staves increase the wielder's maximum MP by 10 per increase in equipment rank (for example a Beginner staff grants maximum MP~+10, an Advanced rod grants MP~+20). In exchange, staves cannot have more than 1d DMG.}
}
%
\vfill
%
...
{\oficonweapon\accf{Rod} & \accf{Unique Effect}}
{
	...
	Adamantine Rod & This weapon does not suffer from the same penalty as other rods. It has the same DMG as any other weapon of the same rank.\ofrow %TODO
	Stardust Rod & When you reduce an enemy to 0 HP, you regain an amount of MP equal to your current Level. \ofrow
	Lilith Rod & While you are concentrating, you can still use the Dash action. \ofrow %TODO
