\ofjob{Summoner}
{
	...
	Most powerful heroes are able to call summons, but the bonds created \accf{Summoners} are far stronger.
	While Summoners are competent with Magic, they thrive when fighting alongside their summons on the battlefield.
}
{Rod or Staff}{Robe}{
	Level 1: & HP +16 & MP~+25 & AGI~+2 & STR~+1 \\ 
	...
	\ofjobspell{Summon: Carbuncle}{10}{1r}{1u}{1u}{
		You gain the ability to summon \acc{Carbuncle}.
		In combat, summons always take their turn right after yours, following your command.
		Summons are dismissed when they suffer KO, when you summon again or when you decide to dismiss them.
		The current HP and MP of a summon is the same as when it was dismissed, if it suffered KO, it is summoned with 1 HP.
		Summons fully recover their HP and MP when you go to sleep.
		Details on all Summons are shown on the next page.
		Summons Level Up together with you where they gain the same attribute increases as you and learn new abilities as shown in their ability lists.
	}{}{1}\vfill
	...
	\ofjobspell{Summon: Bahamut}{8}{1r}{2u}{1u}{You gain the ability to summon \acc{Bahamut}.}{}{8}\ofabilitygap
	...
	{\ofarchetypespella{Pray}{5}{0r}{1u}{Self}{You and all allies in the target area regain 2d HP.}{}}
	{\ofarchetypepassive{Inferno}{You gain the ability to summon \acc{Ifrit} and permanent Resilience against fire damage. Also, whenever your summon deals damage, add your STR and MAG to the summon's for calculating the total damage dealt.}}
...
\clearpage
%
\ofmonster{Carbuncle}{1}{\includegraphics[width=0.25\columnwidth]{./art/jobs/carbuncle.png}}
{
...
\vspace*{1.8cm}\\
%
\ofmonster{Ifrit}{5}{\includegraphics[width=0.28\columnwidth]{./art/jobs/ifrit.png}}
{
...
\newpage
%
\ofmonster{Bahamut}{9}{\includegraphics[width=0.3\columnwidth]{./art/jobs/bahamut.png}}
{
...
\vfill
%
\ofmonster{Shiva}{5}{\includegraphics[width=0.23\columnwidth]{./art/jobs/shiva.png}}
{
