...
To use a Limit Break, characters have to gather 10 \accf{Limit Points~(LP)} as a prerequisite, which are consumed upon activating Limit Break.
...
\ofboxwithtitle{Example: Limit Breaks}{
	...
	Furthermore, Cloud chooses the Automatic Hit, Reposition and Increased Damage improvements to bring is Limit Break's Rating to 5 points.
	Therefore, the new ability allows him to reposition himself and then perform a guaranteed Critical Hit with an additional 2d damage.
