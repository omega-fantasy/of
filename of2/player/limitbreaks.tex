...
\ofbullet{3 LP after using a Talent.}
...
\ofboxwithtitle{Example: Limit Breaks}{
	...
	\ofbullet{Targets suffer additonal damage equal to your current Level.}
	Therefore, the new ability allows him to reposition himself and then perform a guaranteed Critical Hit that ignores the target's DEF and RES and deals 4 extra damage.
