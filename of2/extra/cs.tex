...
\newcommand{\ofcstest}[1]{	
	...
	\begin{multicols}{3}
		...
		\ofcsbox{6}{
			\begin{center}
				...
				\includegraphics[width=0.55\columnwidth]{./art/images/ff9cs.jpg}
			\end{center}
		}
		\ofcsbox{6}{
	...
	\begin{multicols}{2}	
		\ofcsinvisbox{1.5}{
			\oficonhp\acc{H}ealth \acc{P}oints:\hspace*{\fill}\hspace*{0.8cm}\vspace*{-0.175cm}\\
			\hspace*{\fill}{\scriptsize\acc{current}\hspace*{0.3cm}\phantom{|}\hspace*{0.5cm}\acc{maximum}}\hspace*{\fill}\hspace*{1.1cm}\vspace*{-0.1cm}\\
			\hspace*{\fill}\option{/cs/hpcur}\hspace*{0.6cm}|\hspace*{0.6cm}\option{/cs/hpmax}\hspace*{\fill}\hspace*{1.2cm}\\
		}
		\columnbreak
		\ofcsinvisbox{1.5}{
			\oficonmp\acc{M}ana \acc{P}oints:\hspace*{\fill}\hspace*{0.8cm}\vspace*{-0.175cm}\\
			\hspace*{\fill}{\scriptsize\acc{current}\hspace*{0.3cm}\phantom{|}\hspace*{0.5cm}\acc{maximum}}\hspace*{\fill}\hspace*{1.1cm}\vspace*{-0.1cm}\\
			\hspace*{\fill}\option{/cs/mpcur}\hspace*{0.6cm}|\hspace*{0.6cm}\option{/cs/mpmax}\hspace*{\fill}\hspace*{1.2cm}\\
		}
	\end{multicols}
	%
	\vspace*{-0.8cm}
	...
	\ofcsbox{4.5}{
		...
		\oficonpassive \hspace*{-0.3cm} \oficonreaction Special Abilities: \option{/cs/specials}\vspace*{0.6cm}\\
		\oficonmagic Spells \hspace*{0.025cm} and \oficontech Techs:\ofrow \option{/cs/abilities}
	}
	\end{multicols}
	%
	...
	\parbox{1.03\columnwidth}{
		\scriptsize
		\accf{Combat Actions Summary:}\ofrow
		\ofmbox{\oficonsmallattack\acc{Attack:}} 
		...
		\ofmbox{\oficonsmallmagic\acc{Magic:}} Cast a spell by spending MP, choosing a target in range and concentrating.
		...
		\ofmbox{\oficonsmalltech\acc{Tech:}} Used the same way as Magic but add your STR instead of MAG to damage and healing if bonus is not already included.\ofrow
		\ofmbox{\oficonsmalldefend\acc{Defend:}} Damage that you receive by Attacks until your next turn is halved. \ofrow
		\ofmbox{\oficonsmallitem\acc{Item:}} Use an Item from your inventory on yourself or someone within 1u.\ofrow
		\ofmbox{\oficonsmallreequip\acc{Re-Equip:}} Swap a Materia or Equipment piece that you are wearing against one from your Inventory.\ofrow
		\ofmbox{\oficonsmalldash\acc{Dash:}} Move another distance of your AGI+1 units.
	}
	\columnbreak\\
	\parbox{1.03\columnwidth}{
		\scriptsize	
		\accf{Status Effects Summary:}\ofrow
		\ofmbox{\kosmall\accr{KO:}} You are unconscious and your turns are skipped.\ofrow
		\ofmbox{\blindsmall\accr{Blind:}} On Attack, enemy has Advantage on the evasion check. \ofrow
		\ofmbox{\poisonsmall\accr{Poison:}} You take damage equal to 10\% of your maximum HP at the start of each turn, but cannot fall below 1 HP due to this effect.\ofrow
		\ofmbox{\slowsmall\accr{Slow:}} During your turn, you can either move or take an action but not both.\ofrow
		\ofmbox{\sleepsmall\accr{Sleep:}} You can't move or take actions. Removed when you take damage.\ofrow
		\ofmbox{\zombiesmall\accr{Zombie:}} All healing effects are reversed for you.\ofrow
		\ofmbox{\silencesmall\accr{Silence:}} You cannot begin casting Magic or using Techs.\ofrow
		\ofmbox{\immobilesmall\accr{Immobile:}} You are unable to move. \ofrow
		\ofmbox{\destrsmall\dedefsmall\demagsmall\deressmall\accr{DeATR:}} The attribute is reduced by 3, e.g. DeMAG reduces MAG. \ofrow
		\ofmbox{\blinksmall\accg{Blink:}} You have advantage on evasion checks. \ofrow
		\ofmbox{\hastesmall\accg{Haste:}} You can either make an additional action or movement. \ofrow
		\ofmbox{\regensmall\accg{Regen:}} Regain 10\% of your maximum HP at the start of each turn.\ofrow
		\ofmbox{\enstrsmall\enndefsmall\enmagsmall\enressmall\accg{EnATR:}} The attribute is increased by 3, e.g. EnMAG increases MAG.
	}
	\end{multicols}
}
