...
\ofcs{
	...
	weapon=Myhtril Staff, weaponeffect=Extra Materia slot, weapontype=Maximum MP +5, armor=White Robe, armoreffect=Immunity: Sleep, armortype=RES +2,
...
\ofcs{
	...
	weapon=Gunblade, weaponeffect=Ranged attack after ability, weapontype=crit on 11 or 12 enemy evasion check, armor=Myhtril Vest, armoreffect=Extra Materia slot, armortype={DEF +1, RES +1},
...
\ofcs{
	...
	weapon=Stardust Rod, weaponeffect=Regain MP equal to Level on enemy KO, weapontype=MAG +1, armor=Silk Robe, armoreffect=Extra Materia slot, armortype=RES +2,
